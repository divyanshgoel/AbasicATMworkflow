	...
	function checkError() {
		...
		if (withdrawAmount % 50 != 0 || withdrawAmount == 0 || withdrawAmount < 0) {
			...
			if(withdrawAmount > dailyWithdrawLimit) {
				...
				if(o.leftAmount >= withdrawAmount) {
					
					while(o.obj.count_2000 > 0 && withdrawAmount>=2000)
					{
						note2000++;
						withdrawAmount-=2000;
						o.obj.count_2000--;
					...
					while(o.obj.count_500 > 0 && withdrawAmount>=500)
					{
						note500++;
						withdrawAmount-=500;
						o.obj.count_500--;
					...
					while(o.obj.count_100 > 0 && withdrawAmount>=100)
					{
						note100++;
						withdrawAmount-=100;
						o.obj.count_100--;
					...
					while(o.obj.count_50 > 0 && withdrawAmount>=50)
					{
						note50++;
						withdrawAmount-=50;
						o.obj.count_50--;
